			...
			<tr>
				<td>
					<table width="100%" cellspacing="0" cellpadding="0" border="0">
						<tbody>
							<tr valign="top">
								<td style="width:90px"><span style="border:1px solid #cccccc; display:block"><a href="{{url($datos['img_prod'])}}" target="_blank" rel="noopener noreferrer"><img data-imagetype="External" src="{{asset($datos['img_prod'])}}" width="90" height="90" style="display:block"></a> </span></td>
								<td>
